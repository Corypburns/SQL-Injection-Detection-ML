...
# Paths
output_path = '/home/cory/code/CISResearchSummer2025/Outputs/SGDClassifier/SGDClassifier-SQLiExtended'
...
output_file = os.path.join(output_path, f"SDGClassifier_{now}.csv")
