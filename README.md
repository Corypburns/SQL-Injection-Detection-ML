...
> ![info-image](https://github.com/Corypburns/SQL-Injection-Detection-ML/blob/master/Info.svg) **__NOTE__**:  Installing Python also installs Pip. We took care of two birds with one stone with one step.
<br><br><br>
